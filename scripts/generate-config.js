...
const config = {
    WS_URL: process.env.WS_URL || (isNetlify ? 'wss://tilt-battle-royale.fly.dev' : 'ws://localhost:8080'),
    API_URL: process.env.API_URL || (isNetlify ? 'https://tilt-battle-royale.fly.dev' : 'http://localhost:8080'),
